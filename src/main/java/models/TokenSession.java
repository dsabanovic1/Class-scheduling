...
public class TokenSession {
    ...
    public static TokenSession generateSessionToken(String userId)
        ...
        PreparedStatement ps = Database.prepareStatement("SELECT * FROM school.token_sessions WHERE user_id = ? LIMIT 1");
        ...
        ps = Database.prepareStatement("INSERT INTO school.token_sessions (token_session_id, user_id, token) VALUES (?,?,?)");
    ...
    {
        PreparedStatement ps = Database.prepareStatement("SELECT * FROM school.token_sessions WHERE token = ? LIMIT 1");
